...
district.classification.desc.path <- paste0(src.dir, '/Data/District_Classification_Description.csv')
district.classification.path <- paste0(src.dir, '/Data/District_Classification-2013-14.csv')
district.classification.desc <- read.csv(district.classification.desc.path, col.names = c('ClassCode', 'ClassDescription'))
district.classification <- read.csv(district.classification.path, col.names = c('District', 'ClassCode'))

raw.dat <- merge(raw.dat, district.classification, by = 'District')
raw.dat <- merge(raw.dat, district.classification.desc, by = 'ClassCode')
